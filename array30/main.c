//30. Write a program to find the median of a sorted array. The numbers are in increasing order. Print the average of the two
//  center elements if the length of the array is even.
//  Array: 1 2 3 4 5 6 7 8 9 Output: 5
